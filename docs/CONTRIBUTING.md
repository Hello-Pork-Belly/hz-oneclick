...
## Maintainer CI notes
Maintainers can use the details below to validate CI parity and self-hosted runners. End users installing via `curl` do not need these steps.
...
```bash
HZ_LINT_STRICT=1 bash scripts/ci_local.sh
```
