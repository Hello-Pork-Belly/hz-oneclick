...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 01 | Document default install paths with placeholders | docs/README.md | Paths are inconsistent across docs | Paths use placeholders like `/var/www/your-site/html` | Audit docs for path examples and standardize | TODO | TBD |
